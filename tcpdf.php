...
class TCPDF {
	...
	public function Header() {
		if ($this->header_xobjid === false) {
			...
			//header line
			$headerdata1 = 'Bicol University';
				$headerdata2 = '(Polangui Campus)';

				// header string 1
				$this->setFont($headerfont[0], $headerfont[1], $headerfont[2]);
				$this->setX($header_x);
				$this->MultiCell($cw, $cell_height, $headerdata1, 0, '', 0, 1, '', '', true, 0, false, true, 0, 'T', false);

				// header string 2
				$this->setFont($headerfont[0], $headerfont[1], $headerfont[2]);
				$this->setX($header_x);
				$this->MultiCell($cw, $cell_height, $headerdata2, 0, '', 0, 1, '', '', true, 0, false, true, 0, 'T', false);
